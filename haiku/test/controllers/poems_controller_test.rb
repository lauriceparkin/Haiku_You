...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post poems_url, params: { poem: { content: @poem.content, user_id: @poem.user_id } }, as: :json
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { content: @poem.content, user_id: @poem.user_id } }, as: :json
    assert_response 200
  end
