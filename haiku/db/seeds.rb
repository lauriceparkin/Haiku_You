...
haiku = Poem.create!(content:"Urban chaos in brain, Should I have just stayed in bed?, Splendid noise ahead", user_id: 1)
...
Poem.users(content:"Looking for answers, Invisible to the eye, Persistent with hope", user_id: 1)
