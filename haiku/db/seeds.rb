...
Poem.create!(content:"Urban chaos in brain, Should I have just stayed in bed?, Splendid noise ahead", user: 1)

Poem.create!(content:"Feel the cold wind whip, No warm sad between my toes, The waves crash with chills", user: 1)

Poem.create!(content:"Buy it, Cook it, Eat, Did you test the recipe?, Pain in my belly", user: 1)
